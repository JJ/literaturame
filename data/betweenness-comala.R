...
ggplot()+geom_point(data=bet.comala.df,aes(x=reorder(personajes,-betweenness.g.),y=betweenness.g.))+scale_y_log10()+theme_tufte()+ theme(axis.text.x = element_text(angle = 90, hjust = 1))
