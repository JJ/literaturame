...
\caption{Summary of coefficients of the linear models adjusting the
 ...
 a bad fit).  0 $<$ Coefficients $<$ -2 correspond to pink noise. \label{t:spec}}
\end{table}
...
self-organization arises, between 100 and 1000 commits. A comparison
between these and other types might show statistically significant
differences, which would be attributed rather 
...
TIN2014-56494-C4-\{1,3\}-P (\{UMA,UGR\}-EPHEMECH) and by Consejo Nacional de Ciencia y Tecnolog\'{\i}a under project 220590.
