...
% Antonio - lo que viene a continuación yo lo pondría al inicio de la sección, para introducir el concepto de 'critical state', que se referencia justo al principio de la introducción ahora.
% Cambiado más arriba. Ahora habrá que re-revisar - JJ
% Antonio - hecho. ahora está mejor creo yo. ;)
...
% Antonio - no sé la validez que tendrá esta evidencia...
% Sólo para confirmar que no sólo sucede en grandes proyectos. El
% paper está para probarlo - JJ
% Antonio - ok
...
% Antonio - se acaba de decir que no hay 'master', aunque ya sé que se llama así la rama principal, queda un poco incongruente. Yo quitaría el master arriba, dejando sólo 'central'
% Corregido
...
% Antonio - cita...
% Más bien explicación - JJ
% Antonio - ok, mejor ahora
...
of finding out how that complex network effectively emerges. 
...
the power spectral density. This is shown in Figure \ref{fig:spectrum}, where the power spectral density is shown for the four papers. 
% Antonio - ¿por qué sólo sobre los 4 artículos? Aclararlo
A {\em pink noise} would be characterized by a spectrum with a negative slope, with decreasing power the higher the frequency. 
% Antonio - 'with the lower the power, the higher the frequency'?
%
% in this figure, the different subplots should be identified (maybe including the name of repo in each case)  - Pedro
...
Once the three main features of systems in self-organized 
% Antonio - critical?
state have
been measured for the papers 
% Antonio - papers y otro tipo de proyectos, no?
under study, we will present in the next
