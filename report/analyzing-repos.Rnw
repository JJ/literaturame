...
network. \cite{valverde2007self}, for instance, 
have proved how this network grows under the tension of top-down or
hierarchical rules and self-organization emerging from the bottom,
which make software development teams a complex social system. This
would indicate that the self-organized critical state would be much
...
We extact this information via a Perl script, that generates a {\tt
