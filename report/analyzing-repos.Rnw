...
Software projects behave as complex social systems, and the fact that
many of them, mainly in large, long-running projects, of a self-organized critical state \cite{bak1988self} in 
