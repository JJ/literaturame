...
In this paper we were interesting in finding traces of self-organized criticality in the repositories of scientific papers 
% Antonio - papers y otro tipo de proyectos, no?
by looking for certain features that are peculiar to the critical state: scale-free behavior, long-distance correlations and pink noise. 
...
between submission and the first revision. 
% Antonio - este paper no se ha enviado todavía... :D
Thus, we think that commits, and
