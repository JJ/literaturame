...
for (i in 1:length(files) ) {
    lines[[i]] <-  read.csv(paste0(pref,files[i],'.csv'))
...
% No te entiendo, Antonio. Ya se ha dicho más arriba por qué se
% escogen sólo esos ficheros, precisamente donde las wildcards - JJ
