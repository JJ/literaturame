...
and more natural and precise methodology, several
...
We have chosen 16 
% Antonio - own? public?
repositories in different states of development, and representing from web frameworks such as Django to Atom plugins in the case of {\em language-perl6e}. They include many different languages, either interpreted or compiled, and vary also in {\em professionalism}, from the aforementioned plugin to Docker (an open platform for building and running distributed applications), 
...
\caption{Summary of statistical measures for the software repositories we have
  ...
  the extension. For instance, the first one has directories up to depth 4
