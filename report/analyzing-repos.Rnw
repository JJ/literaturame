...
We have chosen 16 
% Antonio - own? public?
repositores in different states of development, and representing from web frameworks such as Django to Atom plugins in the case of {\em language-perl6e}. They include many different languages, either interpreted or compiled, and vary also in {\em profesionality}, from the aforementioned plugin to Docker (an open platform for building and running distributed applications), 
