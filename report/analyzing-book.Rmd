...
abstract: |
   ...
   Our intention is to prove that self-organization is probably caused by the nature of the media or the use of a software repository; it cannot be, then, a property of the social network of authors, which does not exist, but of the writing process and substrate itself. Excluding the need of a social network lowers the threshold for the existence of self-organization, and, at the same time, gives a completely new measure of performance in a creative process, writing: the existence or not of self-organization.
---
