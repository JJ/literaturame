...
abstract: |
   In this paper we will examine if a particular source-control system repository, devoted to the collaborative writing of an academic paper, is in a self-organized critical state, which can be measured by the existence of a scale-free structure, long-distance correlations and pink noise when analyzing the size of changes and its time series.
...
library(TTR)
#use 
file <- '../data/papers/lines_2015_books_ALL_tex.csv'
# for testing here
