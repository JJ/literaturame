...
%
%
We can in fact fit these charts to a Zipf distribution, whose Zipf exponents and intercepts for these models are shown in Table \ref{t:zipf}, and are of the same order, but different range, of those found in
