...
@
\caption{Number of lines changed per commit in a log-y scale. The four charts
  correspond to, starting with the top right, DCAI, PPSN, book prediction,
  and volunteer computing at the lower bottom. This order is going to be
