...
software repository for the Moose library, in this report we are going %Reference?
...
develop using open software repositories, and this one can be found in
...
a year, and in fact in this precise moment it is in the reviewing process 
to be submitted again to a journal. Collaboratively \emph{developing} a
...
Coming up next, we will examine the methodology followed in the extraction of
information from the repository and how we have processed it. After
presenting a brief state of the art next, \protect\hyperlink{res}{results} 
