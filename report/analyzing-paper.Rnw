...
\begin{abstract}
  ...
  papers by our research team is taking place show hints of a critical   % what subject correspond the verb "show" in this sentence? it is a bit long and difficult to understand...  - Pedro
...
long-scale correlations. The partial autocorrelation is plotted in
Figure \ref{fig:auto}.
...
the power spectral density, shown in Figure \ref{fig:spectrum}.
