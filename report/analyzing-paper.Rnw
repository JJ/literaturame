...
\begin{abstract}
  ...
  the top, which allows that self organization emerges the collaboration and the way it is done. This is why finding if self-organization takes place and under which
